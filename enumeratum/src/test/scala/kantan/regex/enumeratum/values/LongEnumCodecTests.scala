...
class LongEnumCodecTests extends FunSuite with Discipline {
  ...
  checkAll("GroupDecoder[EnumeratedLong]", GroupDecoderTests[EnumeratedLong].decoder[String, Float])
  checkAll("MatchDecoder[EnumeratedLong]", MatchDecoderTests[EnumeratedLong].decoder[String, Float])

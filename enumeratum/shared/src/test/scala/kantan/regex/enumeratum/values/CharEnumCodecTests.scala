...
class CharEnumCodecTests extends DisciplineSuite {
  ...
  checkAll("GroupDecoder[EnumeratedChar]", GroupDecoderTests[EnumeratedChar].decoder[String, Float])
  checkAll("MatchDecoder[EnumeratedChar]", MatchDecoderTests[EnumeratedChar].decoder[String, Float])

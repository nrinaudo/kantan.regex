...
/** Declares [[kantan.regex.GroupDecoder]] instances for java8 date and time types.
  ...
  * priority. This is necessary because the standard use case will be to `import kantan.regex.java8._`, which brings
...
package object java8 extends TimeDecoderCompanion[Option[String], DecodeError, codecs.type] with ToFormatLiteral {
  ...
  override def decoderFrom[D](d: StringDecoder[D]): Decoder[Option[String], D, DecodeError, codecs.type] =
    codecs.fromString(d)
